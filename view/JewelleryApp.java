...
public class JewelleryApp extends javax.swing.JFrame {
    ...
    // Method to to add necklace data in necklacelist
    ...
    // Method to to add bracelet data in braceletlist
    ...
    // Method to to add ring data in ringlist
    ...
    // Method to to add earrings data in earringslist
        ...
        if (pCode.isEmpty() || pName.isEmpty() || pMaterial.isEmpty() || pDCarat.isEmpty() 
            ...
            try {
                ...
                if (!validationErrors.isEmpty()) {
                    ...
                    // Check and update necklace list
                    for (JewelleryModel necklace : necklaceList) {
                        if (necklace.getCode() == jCode) {
                            necklace.setName(pName);
                            necklace.setMaterial(pMaterial);
                            necklace.setdCarat(dCarat);
                            necklace.setgCarat(gCarat);
                            necklace.setStock(jStock);
                            necklace.setCost(jCost);
                            loadListToTable(necklaceList, tblNecklace); //Update new data to the table
                            isUpdated = true;
                            break;
                        }
                    }
                    // Check and update bracelet list
                    if (!isUpdated) {
                        for (JewelleryModel bracelet : braceletList) {
                            if (bracelet.getCode() == jCode) {
                                bracelet.setName(pName);
                                bracelet.setMaterial(pMaterial);
                                bracelet.setdCarat(dCarat);
                                bracelet.setgCarat(gCarat);
                                bracelet.setStock(jStock);
                                bracelet.setCost(jCost);
                                loadListToTable(braceletList, tblBracelet); //Update new data to the table
                                isUpdated = true;
                                break;
                            }
                        }
                    }
                    // Check and update ring list
                    if (!isUpdated) {
                        for (JewelleryModel ring : ringList) {
                            if (ring.getCode() == jCode) {
                                ring.setName(pName);
                                ring.setMaterial(pMaterial);
                                ring.setdCarat(dCarat);
                                ring.setgCarat(gCarat);
                                ring.setStock(jStock);
                                ring.setCost(jCost);
                                loadListToTable(ringList, tblRings); //Update new data to the table
                                isUpdated = true;
                                break;
                            }
                        }
                    }
                    // Check and update earrings list
                    if (!isUpdated) {
                        for (JewelleryModel earrings : earringsList) {
                            if (earrings.getCode() == jCode) {
                                earrings.setName(pName);
                                earrings.setMaterial(pMaterial);
                                earrings.setdCarat(dCarat);
                                earrings.setgCarat(gCarat);
                                earrings.setStock(jStock);
                                earrings.setCost(jCost);
                                loadListToTable(earringsList, tblEarRings); //Update new data to the table
                                isUpdated = true;
                                break;
                            }
                        }
    ...
    //Method to add details in the list and table
    ...
    // Method for implementing binary search in Necklace List
    ...
    // Method for implementing binary search in Bracelet List
    ...
    // Method for implementing binary search in Ring List
    ...
    // Method for implementing binary search in Earrings List
    ...
    // Method for implementing sorting algorithm in Necklace combobox
    private void cbNecklaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbNecklaceActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_cbNecklaceActionPerformed
    
    // Method for implementing sorting algorithm in Bracelet combobox
    private void cbBraceletActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbBraceletActionPerformed
        SelectionSort selectionSort = new SelectionSort();
        InsertionSort insertionSort = new InsertionSort();
        MergeSort mergeSort = new MergeSort();
    ...
    }//GEN-LAST:event_cbBraceletActionPerformed

    // Method for implementing sorting algorithm in Ring combobox
    private void cbRingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbRingActionPerformed
        SelectionSort selectionSort = new SelectionSort();
        InsertionSort insertionSort = new InsertionSort();
        MergeSort mergeSort = new MergeSort();
    ...
    }//GEN-LAST:event_cbRingActionPerformed

    // Method for implementing sorting algorithm in Earrings combobox
    private void cbEarringsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbEarringsActionPerformed
        SelectionSort selectionSort = new SelectionSort();
        InsertionSort insertionSort = new InsertionSort();
        MergeSort mergeSort = new MergeSort();
    ...
    }//GEN-LAST:event_cbEarringsActionPerformed
